...
def generate_launch_description():
    ...
    # diff-drive for wheels
    dd_node = Node(
        package='controller_manager',
        executable='spawner',
        arguments=['mobile_base_dd_controller',
                '--controller-manager', '/controller_manager'
        ],
    )
    #ld.add_action(dd_node)

    # controller for the virtual joint
    base_node = Node(
        package='controller_manager',
        executable='spawner',
        arguments=['base_planar_controller',
                '--controller-manager', '/controller_manager'
        ],
    )
    ...
    bridge = Node(
        ...
        executable='mobile_base_bridge.py',
        output='screen'
    )
